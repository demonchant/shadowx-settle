...
var ICONS = {
  add: async () => (await import("./add-2IUEYVPE.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-LPW4JHZ5.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-AKQBY27W.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-G63ESQRB.js")).appStoreSvg,
  apple: async () => (await import("./apple-QNV4YZFJ.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-6WQOQQRX.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-K7RSJR6Q.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-7KIUUXCS.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-EPEDOVRL.js")).arrowTopSvg,
  bank: async () => (await import("./bank-AZPEAWLL.js")).bankSvg,
  browser: async () => (await import("./browser-ZAOX55SL.js")).browserSvg,
  card: async () => (await import("./card-FU6PVDFE.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-PWA76XUD.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-XCADVOIC.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-ZYKCDAEW.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-BL7ZQ2IY.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-SORDISIE.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-IDVAO3CQ.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-NI7OD56H.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-EEOP6SDS.js")).clockSvg,
  close: async () => (await import("./close-KZAW2YSO.js")).closeSvg,
  compass: async () => (await import("./compass-SFFQFVLY.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-YXYXJXNO.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-YKZS3FQM.js")).copySvg,
  cursor: async () => (await import("./cursor-S2FDKFS4.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-BNCV24TF.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-FDLE6S4W.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-PI7THCF3.js")).disconnectSvg,
  discord: async () => (await import("./discord-546A6KMJ.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-MGAKK4CI.js")).etherscanSvg,
  extension: async () => (await import("./extension-YBPZF77G.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-7PAJW3WH.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-MOI3PYWA.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-XWMLIGVV.js")).farcasterSvg,
  filters: async () => (await import("./filters-GYU23CZY.js")).filtersSvg,
  github: async () => (await import("./github-QYXFVP2J.js")).githubSvg,
  google: async () => (await import("./google-UOYFZBLC.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-6GKCTG7A.js")).helpCircleSvg,
  image: async () => (await import("./image-UJ3QQK4B.js")).imageSvg,
  id: async () => (await import("./id-3K5I6G3Q.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-BC4A73VS.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-LK5BKO2I.js")).lightbulbSvg,
  mail: async () => (await import("./mail-PAWDRT3G.js")).mailSvg,
  mobile: async () => (await import("./mobile-BZBMKJ2I.js")).mobileSvg,
  more: async () => (await import("./more-VR77IBGH.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-CF5A5OQF.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-BTYMPT6I.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-5CRD5642.js")).offSvg,
  playStore: async () => (await import("./play-store-SQ4CYP3B.js")).playStoreSvg,
  plus: async () => (await import("./plus-RHAU6KA2.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-R3VIVU2G.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-C7GP6JBF.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-J6LRU7CB.js")).refreshSvg,
  search: async () => (await import("./search-QPURRLXU.js")).searchSvg,
  send: async () => (await import("./send-I2U6SHGM.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-VGS55BJQ.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-X2DRSDNR.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-5MBMBVWN.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-QEH2VO4M.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-6D3OW2I6.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-BYVU25HN.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-CP56JW6F.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-VRE72JWV.js")).twitchSvg,
  twitter: async () => (await import("./x-K6M3MLQP.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-FNGHFUEQ.js")).twitterIconSvg,
  verify: async () => (await import("./verify-VJGKRKY2.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-LAXAORYH.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-MDGUK2T2.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-DI6HAUDW.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-DI6HAUDW.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-DI6HAUDW.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-M332DGFX.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-PAAACF5J.js")).warningCircleSvg,
  x: async () => (await import("./x-K6M3MLQP.js")).xSvg,
  info: async () => (await import("./info-XEKIO6NY.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-5W7GTSN5.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-3ZMIMGSW.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AJN673OX.js.map
