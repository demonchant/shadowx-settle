...
import {
  ...
  validate2,
  validateObject
} from "./chunk-LVDTRXD5.js";
import {
  require_elliptic
} from "./chunk-DZIPKZH4.js";
import {
  HashMD as HashMD2
...
async function recoverPublicKey2({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k14 } = await import("./secp256k1-5BYKDN5O.js");
  const signature_ = (() => {
...
function decodeEventLog2(parameters) {
  ...
  const abiItem = abi.find((x5) => x5.type === "event" && signature === toEventSelector(formatAbiItem2(x5)));
  if (!(abiItem && "name" in abiItem) || abiItem.type !== "event")
    throw new AbiEventSignatureNotFoundError(signature, { docsPath });
  const { name: name2, inputs } = abiItem;
  const isUnnamed = inputs == null ? void 0 : inputs.some((x5) => !("name" in x5 && x5.name));
  ...
  return logs.map((log) => {
    ...
    if (!event && !strict) {
      ...
      try {
        ...
        const isUnnamed = (_a = abiItem.abi.inputs) == null ? void 0 : _a.some((x5) => !("name" in x5 && x5.name));
        return {
          ...formattedLog,
          args: isUnnamed ? [] : {},
  ...
  switch (abiParameterType) {
    ...
    default: {
      ...
      if (/[a-z]+[1-9]{0,3}(\[[0-9]{0,}\])+$/.test(abiParameterType)) {
        return Array.isArray(arg) && arg.every((x5) => isArgOfType2(x5, {
          ...abiParameter,
  ...
  constructor(x5, y4) {
    super("Found ambiguous types in overloaded ABI Items.", {
      metaMessages: [
        ...
        `\`${x5.type}\` in \`${normalizeSignature2(formatAbiItem(x5.abiItem))}\`, and`,
        `\`${y4.type}\` in \`${normalizeSignature2(formatAbiItem(y4.abiItem))}\``,
        "",
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-I4U5464J.js.map
